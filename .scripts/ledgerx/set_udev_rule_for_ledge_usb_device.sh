#!/bin/bash
# Taken from https://raw.githubusercontent.com/LedgerHQ/udev-rules/master/add_udev_rules.sh
# See https://support.ledger.com/hc/en-us/articles/360019301813-Fix-USB-issues
